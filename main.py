...
async def{issue['context']}
```
"""
    return prompt

# Print the example prompt
print("Example Prompt:\n", generate_prompt_example(issue))

# Example 2 to show how to retrieve original code
issue = {
    'filename': 'example.py',
    'line': 5,
    'type': 'SyntaxError',
    'description': 'Invalid syntax',
    'original_code': 'print(x', # Assume this is retrieved
    'context': 'def my_function():\n print(x'
}

def generate_prompt_example_2(issue):
    """Example demonstrating using original code in a prompt."""
    prompt = f"""
There's a syntax error in the following code. Fix it:
